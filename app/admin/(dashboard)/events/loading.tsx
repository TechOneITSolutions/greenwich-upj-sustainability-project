...
function SkeletonRow() {
  return (
    <tr className="border-b border-gray-50">
      ...
      <td className="p-4"><div className="h-4 bg-gray-200 rounded animate-pulse w-1/2" /></td>
        ...
        <table className="w-full text-left">
          <thead className="bg-gray-50 border-b border-gray-100">
            <tr>
              ...
              <th className="p-4"><div className="h-4 w-12 bg-gray-300 rounded animate-pulse" /></th>
              <th className="p-4"><div className="h-4 w-20 bg-gray-300 rounded animate-pulse" /></th>
              <th className="p-4" />
            </tr>
          </thead>
          <tbody>
